...
import static com.facebook.presto.util.KerberosPrincipal.Parser.PARTS_SEPARATOR;
import static com.facebook.presto.util.KerberosPrincipal.Parser.REALM_SEPARATOR;
...
public class KerberosPrincipal
{
    ...
    static class Parser
    {
        static final char REALM_SEPARATOR = '@';
        static final char PARTS_SEPARATOR = '/';
