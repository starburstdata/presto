...
public class ClientSession
{
    ...
    {
        this(server, user, source, clientTags, clientInfo, catalog, schema, timeZoneId, locale, properties, preparedStatements, emptyMap(), transactionId, clientRequestTimeout);
    }
